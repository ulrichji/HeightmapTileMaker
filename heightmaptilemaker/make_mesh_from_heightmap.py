...
if __name__ == '__main__':
    ...
    argument_parser.add_argument('--output', type=str, help='Specify the file of the result .json file')
    ...
    if output_file is not None:
        progress_printer(Progress(0.6, "Saving mesh as " + str(output_file)))
